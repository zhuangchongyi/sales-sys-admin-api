...
public class JwtUtil {
    ...
    private static final String defaultbase64EncodedSecretKey = "123456";
    ...
    public String encode(String iss, long ttlMillis, Map<String, Object> claims) {
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .setId(IdUtil.simpleUUID())//2. 这个是JWT的唯一标识，一般设置成唯一的，这个方法可以生成唯一标识
    ...
    public static void main(String[] args) {
        ...
        JwtUtil util = new JwtUtil(username, SignatureAlgorithm.HS256);
        //以tom作为秘钥，以HS256加密
        ...
        String jwtToken = util.encode(username, 30000, map);

        System.out.println(jwtToken);
        util.decode(jwtToken).entrySet().forEach((entry) -> System.out.println(entry.getKey() + ": " + entry.getValue()));
    }
}